...
namespace CoViD.GUI.Tools.Extensions.Profile
{
	...
	public static class Methods
	{
		...
		//////////////////	@default.Isolation = profile.Read(section, key + ".Isolation", string.Empty).ToPercentage(@default.Isolation);
		...
		//////////////////	profile.Write(section, key + ".Isolation", settings.Isolation);
